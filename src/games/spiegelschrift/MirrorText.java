 ...
 * @see http://math.hws.edu/javanotes/source/MirrorText.java
 * This source code is part of the example section of the free online textbook
 * >>Introduction to Programming Using Java, Sixth Edition<<
 * It is however modified and adjusted so for the original version see the link above.
 */
