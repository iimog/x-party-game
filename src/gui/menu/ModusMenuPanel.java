	...
	public ModusMenuPanel(){
		...
		}
		{
			...
			soloPanel.setOpaque(false);
			{
				...
				soloButton.setText(Modus.SOLO.toString());
				soloButton.setFont(X.buttonFont);
		...
		}
		{
			...
			teamPanel.setOpaque(false);
			{
				...
				teamButton.setFont(X.buttonFont);
